...
if([System.String]::IsNullOrEmpty($AspNetCoreEnv) -eq $true)
{
...
$logFile = Join-Path $env:TEMP -ChildPath "InstallNetFx46AndUpdateEnvScriptLog.txt"

# Set ASPNETCORE_ENVIRONMENT to $AspNetCoreEnv
setx /m ASPNETCORE_ENVIRONMENT $AspNetCoreEnv
